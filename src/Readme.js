        ...
        let readmeGeneral = (
            <div className="readme-background">
                <div className="readme-header">
                    <h3>Algemene uitleg</h3>
                </div>
                <p>
                    Dank voor uw interesse in ons onderzoek over leesimpact! Deze vragenlijst is opgesteld door Peter Boot (<a href="https://www.huygens.knaw.nl/">Huygens ING</a>) en Marijn Koolen (<a href="https://huc.knaw.nl/about/">KNAW

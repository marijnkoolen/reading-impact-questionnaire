...
class ReadmeMore extends Component {
    ...
    render() {
        return (
            <div className="readme-background">
                ...
                <p>
                    Daarvoor kijken we naar het voorkomen van bepaalde woorden en woordcombinaties. De woorden <em>mooi</em> en <em>humor</em> wijzen waarschijnlijk meestal op stilistische impact, het woord <em>spannend</em> op narratief gevoel, het
                ...
                <p>
                    ...
                    Maar is dat zo? <em>Wij</em> kunnen denken dat humor een kwestie is van stijl, of dat gebruik van het woord <em>bizar</em> betekent dat de lezer/reviewer aan het denken is gezet. Maar we willen graag toetsen of dat klopt met hoe mensen ernaar kijken
                    die elke dag reviews lezen en schrijven. Vandaar dat we voor een beperkt aantal zinnen uit de reviews willen vergelijken
                    welke impactaspecten de computer ziet en welke impactaspecten de Hebban-bezoeker onderkent. Dat is het doel van deze enqête. Komen
                    de antwoorden van de computer overeen met die van u, dan hebben wij het goed gedaan en kunnen we verder met de analyse van de reviews.
                ...
                <p>
                    ...
                    op met <a href="mailto:peter.boot@huygens.knaw.nl">peter.boot@huygens.knaw.nl</a> en/of <a href="mailto:marijn.koolen@di.huc.knaw.nl">marijn.koolen@di.huc.knaw.nl</a>.
                </p>
